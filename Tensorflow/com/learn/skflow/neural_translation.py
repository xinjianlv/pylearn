...
# ENGLISH_CORPUS = "/Users/nocml/Program/python/tensorflow/tensorflow/examples/skflow/DATA/small/europarl-v6.fr-en.en.small"
# FRENCH_CORPUS = "/Users/nocml/Program/python/tensorflow/tensorflow/examples/skflow/DATA/small/europarl-v6.fr-en.fr.small"
ENGLISH_CORPUS = "/Users/nocml/Program/python/tensorflow/tensorflow/examples/skflow/DATA/zh_en/clean3.en.small"
FRENCH_CORPUS = "/Users/nocml/Program/python/tensorflow/tensorflow/examples/skflow/DATA/zh_en/clean3.zh.small"

PATH = '/tmp/tf_examples/ntm/'
MODEL_PATH = "/Users/nocml/Program/python/tensorflow/tensorflow/examples/skflow/DATA/model/"
os.popen('rm -rf  ' + MODEL_PATH)
os.popen('rm -rf  ' + PATH)
...
def save_partitions(data, filenames):
    files = [open(filename, 'w',encoding='utf-8') for filename in filenames]
    for partition, item in data:
        print(partition , item)
...
if not (os.path.exists('train.data') and os.path.exists('test.data')):
    ...
    parallel_data = ('%s;;;%s' % (eng, fr) for eng, fr in zip(english_data, french_data))
