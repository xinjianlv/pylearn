...
PATH = '/Users/nocml/Program/python/tensorflow/tensorflow/examples/skflow/DATA'
CORPUS_FILENAME = PATH + '/' + "europarl-v6.fr-en.en"
MAX_DOC_LENGTH = 10
...
estimator.save('/Users/nocml/Program/python/tensorflow/tensorflow/examples/skflow/DATA')